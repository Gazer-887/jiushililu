...
export default function PlusMenu({ picked, onToggle }: PlusMenuProps): JSX.Element {
        ...
        <div className="plus-menu">
          ...
          <div className="plus-section plus-soon">
            ...
            <div className="plus-item disabled">
              ...
              <span className="plus-name">文件 / 图片</span>
              <span className="plus-desc">引用工作区文件进上下文（待做）</span>
            </div>
            <div className="plus-item disabled">
              <span className="plus-check" />
